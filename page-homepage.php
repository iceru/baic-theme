...
if (false === $external_promotions) {
    ...
    $promo_url = 'https://jhlauto.co.id/wp-json/wp/v2/promotions?_embed&per_page=4&orderby=date&order=desc';
...
<section class="bg-jhl-gray-1 text-white relative block md:flex justify-between">
    ...
    <div class="right-0 static md:absolute h-full fade-left" data-scroll data-scroll-class="is-inview"
        ...
        <img src="<?php echo get_template_directory_uri() ?>/images/test-drive.jpg" class="h-full w-auto object-contain"
            alt="">
    </div>
</section>
